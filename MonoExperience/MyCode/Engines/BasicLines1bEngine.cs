...
namespace MonoExperience
{
    ...
    /// </summary>
    public class BasicLines1bEngine : BaseEngine
    {
        ...
        public BasicLines1bEngine(EngineContainer cnt) : base(cnt)
        {
        ...
        {
            return new BasicLines1bEngineControlWindow(guiEngine, this);
        }
        ...
        {
            return @"Draw lines using the DynamicPrimitiveLine class";
        }
