...
namespace MonoExperience
{
    ...
    public class BasicLines1bEngineControlWindow : GuiWindow
    {
        private GuiEngine fGuiEngine;
        private BasicLines1bEngine fEngine;
        private GuiLabel fInfo;
        private GuiLabel fButtonReset;

        public BasicLines1bEngineControlWindow(GuiEngine guiEngine, BasicLines1bEngine engine)
        {
